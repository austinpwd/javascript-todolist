...
const onAppInit = async function(e) {
    let todos = await _dataFetcher.dataFetcher('../data/todos.json');
    if (todos[0].id === undefined) todos = [
        ...keyGenerator(todos)
    ];
    _redux.createStore(todos);
    _router.Router(window.location.pathname);
};
window.addEventListener('load', onAppInit);

},{"./routes/router":"f0QlQ","./utils/dataFetcher":"8J3wM","./redux":"hWnZA"}],"f0QlQ":[function(require,module,exports) {
...
var _addToDoPage = require("../pages/addToDoPage");
var _addToDoPageDefault = parcelHelpers.interopDefault(_addToDoPage);
var _editToDoPage = require("../pages/editToDoPage");
var _editToDoPageDefault = parcelHelpers.interopDefault(_editToDoPage);
var _removeToDoPage = require("../pages/removeToDoPage");
var _removeToDoPageDefault = parcelHelpers.interopDefault(_removeToDoPage);
var _pageNotFound = require("../pages/pageNotFound");
var _pageNotFoundDefault = parcelHelpers.interopDefault(_pageNotFound);
const routes = {
    "/": _homePageDefault.default,
    "/todo": _toDoPageDefault.default,
    "/add-todo": _addToDoPageDefault.default,
    "/edit-todo": _editToDoPageDefault.default,
    "/remove-todo": _removeToDoPageDefault.default
};
const Router = (pathname, params = null)=>{
    ...
    validRoute !== undefined ? app.appendChild(routes[validRoute](params)) : app.appendChild(_pageNotFoundDefault.default());
};

},{"../pages/homePage":"lsS9h","../pages/toDoPage":"B5bua","../pages/addToDoPage":"9Lk8x","../pages/editToDoPage":"j8KhD","../pages/removeToDoPage":"fzo9t","../pages/pageNotFound":"j74bp","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lsS9h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const homePage = function() {
    pageHeader.append(_makeElementDefault.default(_headerDefault.default()));
    pageHeader.append(_brandingHeaderDefault.default());
    linkContainer.className = "link-container";
    linkContainer.append(_linkDefault.default("Go to To-Do List app", "/todo"));
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const header = (elementType = "h1", title = "To-Do 2.0", className = "ui-header")=>{
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const tagline = function(tagline = "It's very simple — you read the protocol and write the code.", className = "ui-tagline") {
...
var _todosDefault = parcelHelpers.interopDefault(_todos);
const toDoPage = function() {
    const todoContent = _todosDefault.default();
    return todoContent;
};
exports.default = toDoPage;

},{"../components/todos":"5YQKZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5YQKZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
var _headerDefault = parcelHelpers.interopDefault(_header);
var _brandingHeader = require("../brandingHeader");
var _brandingHeaderDefault = parcelHelpers.interopDefault(_brandingHeader);
var _todoItem = require("../todos/todoItem");
var _redux = require("../../redux");
var _router = require("../../routes/router");
const todos = function() {
    ...
    pageHeader.append(_makeElementDefault.default(_headerDefault.default("h1", "Current To-Do List")));
    pageHeader.append(_brandingHeaderDefault.default());
    const storedToDo = _redux.getStore();
    const clearContainer = clearToDos();
    const addBtn = _buttonDefault.default("add todo", "test");
...
function todoList(storedToDo, todoData, main) {
    if (storedToDo !== null) {
        const newToDoItems = storedToDo.map((todo)=>_todoItem.todoItem(todo)
        );
...
const clearToDos = function() {
    ...
    const clearAllBtn = _buttonDefault.default("Remove All", "remove-todos");
...
const addToDo = function() {
    _router.Router("/add-todo");
};
function editToDo(e) {
    const currentId = e.currentTarget.parentElement.dataset.key;
    const currentToDo = _redux.getStore().find((todo)=>todo.id === currentId
    );
    _router.Router("/edit-todo", currentToDo);
}
function deleteToDo(e) {
    const currentId = e.currentTarget.parentElement.dataset.key;
    const currentToDo = _redux.getStore().find((todo)=>todo.id === currentId
    );
    _router.Router("/remove-todo", currentToDo);
}
const toggleToDo = function() {
};

},{"../../utils/makeElement":"8ZxEo","../ui/button":"6dHHD","../ui/header":"9iGIZ","../brandingHeader":"6iyzv","../todos/todoItem":"jIX84","../../redux":"hWnZA","../../routes/router":"f0QlQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6dHHD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"../../utils/makeElement":"8ZxEo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jIX84":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _header = require("../../ui/header");
var _headerDefault = parcelHelpers.interopDefault(_header);
const todoItem = ({ id =`` , title =`` , category =`` , isComplete =false , startDate =`` , startTime =`` , endDate =`` , endTime =``  })=>{
    return _makeElementDefault.default(`<li class="todo-item" data-key="${id}">
                    ${_headerDefault.default(`h3`, `<b>Title</b>: ${title}`, "title")}
                    <p class="category"><b>Category</b>: ${category}</p>
                    <p class="time"><b>Time</b>: ${startTime} - ${endTime}</p>
                    <p class="date"><b>Due</b>: ${endDate}</p>
                    <p class="complete"><b>Complete</b>: ${isComplete ? `Completed <i class="fas fa-check-square fa-2x"></i>` : `In Progress <i class="fas fa-spinner fa-2x"></i>`}</p>
                    <span class="edit-icon"><i class="fas fa-edit fa-2x"></i></span>
                    <span class="remove-icon"><i class="fas fa-trash-alt fa-2x"></i></span>
        </li>`);
};

},{"../../../utils/makeElement":"8ZxEo","../../ui/header":"9iGIZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"hWnZA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9Lk8x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _addToDo = require("../components/addToDo");
var _addToDoDefault = parcelHelpers.interopDefault(_addToDo);
exports.default = _addToDoDefault.default;

},{"../components/addToDo":"9uHZz","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9uHZz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
var _brandingHeader = require("../brandingHeader");
var _brandingHeaderDefault = parcelHelpers.interopDefault(_brandingHeader);
var _todoAdd = require("../todos/todoForm/todoAdd");
var _todoAddDefault = parcelHelpers.interopDefault(_todoAdd);
...
const addToDoContainer = function() {
    ...
    const addToDo = _buttonDefault.default('Add', 'submit', 'add-todo', 'add-button');
    const cancelToDo = _buttonDefault.default('Cancel', 'cancel', 'cancel-todo', 'cancel-button');
    const footer = document.createElement("footer");
    addContainer.className = "todo-add";
    pageHeader.append(_makeElementDefault.default(_headerDefault.default("h1", "Add")));
    pageHeader.append(_brandingHeaderDefault.default());
    main.append(_todoAddDefault.default());
...
},{"../../utils/makeElement":"8ZxEo","../ui/button":"6dHHD","../ui/header":"9iGIZ","../brandingHeader":"6iyzv","../todos/todoForm/todoAdd":"9NxEU","../../redux/reducers":"kj5tg","../../redux/actions":"LS1fF","../../routes/router":"f0QlQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9NxEU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
var _uuid = require("uuid");
const newId = _uuid.v4().substr(0, 8);
const todoAdd = function() {
    return _makeElementDefault.default(`
...
},{"../../../utils/makeElement":"8ZxEo","uuid":"ffHPv","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ffHPv":[function(require,module,exports) {
var v1 = require('./v1');
var v4 = require('./v4');
var uuid = v4;
uuid.v1 = v1;
...
},{"./v1":"jva98","./v4":"4Sk2L"}],"jva98":[function(require,module,exports) {
...
},{"./lib/rng":"hoYkJ","./lib/bytesToUuid":"6K30a"}],"hoYkJ":[function(require,module,exports) {
...
},{}],"6K30a":[function(require,module,exports) {
/**
...
},{}],"4Sk2L":[function(require,module,exports) {
var rng = require('./lib/rng');
var bytesToUuid = require('./lib/bytesToUuid');
...
},{"./lib/rng":"hoYkJ","./lib/bytesToUuid":"6K30a"}],"kj5tg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function reducers(action) {
    const state = _.getStore();
    let modifiedState = null;
    let i = state.findIndex((todo)=>todo.id === action.payload.id
    );
    switch(action.type){
        case _actionTypes.TODO_ADDED:
            _.updateStore([
                ...state,
                action.payload
            ]);
            action.cb();
            return _actionTypes.TODO_ADDED;
        case _actionTypes.TODO_EDITED:
            modifiedState = [
                ...state.slice(0, i),
                Object.assign({
            ...
            _.updateStore(modifiedState);
            action.cb();
            return _actionTypes.TODO_EDITED;
        case _actionTypes.TODO_DELETED:
            modifiedState = [
                ...state.slice(0, i),
                ...state.slice(i + 1)
            ];
            _.updateStore(modifiedState);
            action.cb();
            return _actionTypes.TODO_DELETED;
        case _actionTypes.TODO_TOGGLED:
            ...
            action.cb();
            return _actionTypes.TODO_TOGGLED;
        default:
            return state;
    }
}
...
},{"../actionTypes":"lvlHx","..":"hWnZA","../../routes/router":"f0QlQ","lodash":"1vR8I","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lvlHx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TODO_ADDED", ()=>TODO_ADDED
);
parcelHelpers.export(exports, "TODO_EDITED", ()=>TODO_EDITED
);
parcelHelpers.export(exports, "TODO_DELETED", ()=>TODO_DELETED
);
parcelHelpers.export(exports, "TODO_TOGGLED", ()=>TODO_TOGGLED
);
...
},{}],"LS1fF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "toggleStatus", ()=>toggleStatus
);
var _actionTypes = require("../actionTypes");
var _router = require("../../routes/router");
const addToDo = {
    type: _actionTypes.TODO_ADDED,
    payload: {
        id: "",
        category: "",
        title: "",
    ...
    cb: ()=>_router.Router('/todo')
};
const editToDo = {
    type: _actionTypes.TODO_EDITED,
    payload: {
        id: "",
        category: "",
        title: "",
...
const deleteToDo = {
    type: _actionTypes.TODO_DELETED,
    payload: {
        id: ""
    },
    cb: ()=>_router.Router('/todo')
...
const toggleStatus = {
    type: _actionTypes.TODO_TOGGLED,
    payload: {
        id: "",
        isComplete: false
    }
...
},{"../actionTypes":"lvlHx","../../routes/router":"f0QlQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"j8KhD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _editToDo = require("../components/editToDo");
var _editToDoDefault = parcelHelpers.interopDefault(_editToDo);
exports.default = _editToDoDefault.default;

},{"../components/editToDo":"emO7l","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"emO7l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
var _brandingHeader = require("../brandingHeader");
var _brandingHeaderDefault = parcelHelpers.interopDefault(_brandingHeader);
var _todoEdit = require("../todos/todoForm/todoEdit");
...
const editToDoContainer = function(todo) {
    ...
    const main = document.createElement(`main`);
    const buttonsContainer = document.createElement("div");
    const editToDo = _buttonDefault.default('Edit', 'submit', 'edit-todo', 'edit-button');
    const cancelToDo = _buttonDefault.default('Cancel', 'cancel', 'cancel-todo', 'cancel-button');
    const footer = document.createElement("footer");
    editContainer.className = "todo-edit";
    pageHeader.append(_makeElementDefault.default(_headerDefault.default("h1", "Edit To Do")));
    pageHeader.append(_brandingHeaderDefault.default());
    buttonsContainer.className = "buttons";
    ...
    buttonsContainer.append(cancelToDo);
    const todoContainer = _todoEditDefault.default(todo);
...
exports.default = editToDoContainer;
...
},{"../../utils/makeElement":"8ZxEo","../ui/button":"6dHHD","../ui/header":"9iGIZ","../brandingHeader":"6iyzv","../todos/todoForm/todoEdit":"6FayR","../../redux/actions":"LS1fF","../../routes/router":"f0QlQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../../redux/reducers":"kj5tg"}],"6FayR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"../../../utils/makeElement":"8ZxEo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fzo9t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _removeToDo = require("../components/removeToDo");
var _removeToDoDefault = parcelHelpers.interopDefault(_removeToDo);
exports.default = _removeToDoDefault.default;

},{"../components/removeToDo":"eU4CO","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"eU4CO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
var _brandingHeader = require("../brandingHeader");
var _brandingHeaderDefault = parcelHelpers.interopDefault(_brandingHeader);
var _todoRemove = require("../todos/todoForm/todoRemove");
var _todoRemoveDefault = parcelHelpers.interopDefault(_todoRemove);
var _actions = require("../../redux/actions");
var _router = require("../../routes/router");
var _reducers = require("../../redux/reducers");
var _reducersDefault = parcelHelpers.interopDefault(_reducers);
const removeToDoContainer = function(todo) {
    ...
    const buttonsContainer = document.createElement("div");
    const removeToDo = _buttonDefault.default('Remove', 'submit', 'remove-todo', 'remove-button');
    const cancelToDo = _buttonDefault.default('Cancel', 'cancel', 'cancel-todo', 'cancel-button');
    const footer = document.createElement("footer");
    pageHeader.append(_makeElementDefault.default(_headerDefault.default("h1", "Delete To Do")));
    pageHeader.append(_brandingHeaderDefault.default());
    ...
    buttonsContainer.append(cancelToDo);
    main.append(_todoRemoveDefault.default(todo));
    main.append(buttonsContainer);
...
exports.default = removeToDoContainer;
const onClick_Cancel = function() {
    _router.Router("/todo");
};

},{"../../utils/makeElement":"8ZxEo","../ui/button":"6dHHD","../ui/header":"9iGIZ","../brandingHeader":"6iyzv","../todos/todoForm/todoRemove":"egwv2","../../redux/actions":"LS1fF","../../routes/router":"f0QlQ","../../redux/reducers":"kj5tg","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"egwv2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
exports.default = todoRemove;

},{"../../../utils/makeElement":"8ZxEo","../../ui/header":"9iGIZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"j74bp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _header = require("../components/ui/header");
var _headerDefault = parcelHelpers.interopDefault(_header);
...
const pageNotFound = function() {
    ...
    linkContainer.className = "link-container";
    linkContainer.appendChild(_linkDefault.default("take me back to safety", "/"));
    main.appendChild(_makeElementDefault.default(_headerDefault.default("h1", "404 - Not Found. You are totally lost right now.")));
...
},{"../components/ui/header":"9iGIZ","../components/brandingHeader":"6iyzv","../utils/makeElement":"8ZxEo","../components/ui/link":"hFEwy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8J3wM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["cSv3F","3auaO"], "3auaO", "parcelRequire7992")
